        ...
        {holders.map((holder) => (
          ...
          >
            <div className="flex items-center gap-3 xs:gap-6 min-w-0 flex-1">
              <div className="size-16 xs:size-22 shrink-0 rounded-full border border-gray-modern-700 bg-gray-modern-800 transition-transform duration-300 group-hover:scale-110" />
              <div className="flex flex-col gap-1.5 xs:gap-3 min-w-0 flex-1">
                <p className="text-white text-xs xs:text-sm font-bold tracking-[-2px] truncate">
                  {holder.handle}
                </p>
                <a
                  ...
                  className="text-gray-modern-25 underline text-[11px] xs:text-[12px] tracking-[-2px] hover:text-white transition-colors"
                >
                  {holder.profile}
                </a>
                <p className="text-aqua-marine-400 text-[10px] font-bold xs:hidden">
                  {holder.count}
                </p>
              </div>
            </div>
            ...
            <div className="hidden xs:flex xs:flex-col xs:items-end gap-1.5 text-aqua-marine-400 text-xs font-bold shrink-0">
              ...
              />
              <span className="whitespace-nowrap">{holder.count}</span>
            </div>
          </div>
        ))}
      </div>
